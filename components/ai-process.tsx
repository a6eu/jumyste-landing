...
const AiProcess = () => {
    return (
        ...
        >
            ...
            <div className="flex gap-14 flex-col items-center lg:items-baseline lg:flex-row lg:justify-between max-w-[1297px] mx-auto mt-16">
                <div className="w-[328px] flex flex-col gap-3 items-center text-center">
                    ...
                    <div>
                        ...
                        <p className="text-black text-xl font-light">
                            ИИ сканирует резюме, анализирует опыт, навыки и
                            квалификацию кандидатов
                        </p>
                    </div>
                </div>
                <Image
                    className="self-center rotate-90 lg:rotate-0"
                ...
                <div className="w-[328px] flex flex-col gap-3 items-center text-center">
                    ...
                    <div>
                        ...
                        <br />
                        <p className="text-black text-xl font-light">
                            После отбора ИИ оценивает каждого кандидата по
                            уровню соответствия ваканси
                        </p>
                    </div>
                </div>
                <Image
                ...
                <div className="w-[328px] flex flex-col gap-3 items-center text-center">
                    ...
                    <div>
                        ...
                        <p className="text-black text-xl font-light">
                            ...
                            отправляет уведомления, приглашения на собеседования
                            и тестовые задания
                        </p>
                    </div>
                </div>
